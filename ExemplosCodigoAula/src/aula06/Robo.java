...
public class Robo {
	 ...
	 * (2) Escrever um outro construtor no qual o robo e
	 *     criado no estado desligado, velocidade igual a
	 *     zero, direcao igual a zero.
	 * (3) Escrever um segundo metodo andar (sobrecarga) cujo incremento da
	 *     velocidade e fornecida como argumento
	 * (4) Escrever um segundo metodo virar (sobrecarga) cuja incremento da
	 *     direcao e fornecida como argumento
	 * (5) Sobrescrever o método toString que imprima o estado atual
	 * do robo
	 */
}
